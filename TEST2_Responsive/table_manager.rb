...
### HTML - Insert numbers into given table. 
  ...
  def insert_links_with_numbers(outputfile)
    ...
    # First Gsub: Inserting <a> when IMG has alt-number # Second Gsub: Replace some IMGs to &nbsp; IMG has alt-N or any letters # Third Gusb: Adjust CTA's TD width to be centered  
  ...
  def last_clean_up(outputfile)
    str_html = File.read(outputfile)
    # Get rid of html tags and insert media query. Get rid of amp;. Keep &nbsp;
...
# Select Gender Here,
SelectedGender = 'M' # Please Type A Capital Letter 'F' or 'M'
